...
'applinks:staging.app.sfproject.net',
'appclips:app.sfproject.net',
'appclips:go.app.sfproject.net', // Allows App Clip to work when scanning QR codes
  ...
  return {
    expo: {
      ...
      updates: {
        url: 'https://updates.app.sfproject.net/manifest',
