...
Environment=NODE_ENV=production
Environment=BSKY_PUBLIC_URL=https://$DOMAIN
Environment=BSKY_SERVER_DID=did:web:$DOMAIN
...
Environment=BSKY_IMG_URI_ENDPOINT=https://$DOMAIN/img
...
Environment=OZONE_APPVIEW_URL=https://$DOMAIN
Environment=OZONE_APPVIEW_DID=did:web:$DOMAIN
